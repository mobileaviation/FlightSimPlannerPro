...
import com.mobileaviationtools.flightsimplannerpro.Search.SearchAirportsPopup;
...
public class NewRouteActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Route flightPlan = new Route(NewRouteActivity.this);
                ...
                if (departureAirport!=null)
                {
                    ...
                    depLoc.latitude = departureAirport.latitude_deg;
                    depLoc.longitude = departureAirport.longitude_deg;
                ...
                if (destinationAirport!=null)
                {
                    ...
                    destLoc.latitude = destinationAirport.latitude_deg;
                    destLoc.longitude = destinationAirport.longitude_deg;
...
//                    endWaypoint.distance_total = Math.round(startWaypoint.location.distanceTo(endWaypoint.location));
                    ...
                    RouteDataSource flightPlanDataSource = new RouteDataSource(getBaseContext());
